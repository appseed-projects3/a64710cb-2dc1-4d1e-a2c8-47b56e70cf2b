...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-18 18:58`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a64710cb-2dc1-4d1e-a2c8-47b56e70cf2b.git
$ cd a64710cb-2dc1-4d1e-a2c8-47b56e70cf2b
```
